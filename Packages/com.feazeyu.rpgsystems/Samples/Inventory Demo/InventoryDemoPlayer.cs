...
namespace Feazeyu.RPGSystems.Demo
{
    ...
    public class InventoryDemoPlayer : MonoBehaviour
    {
        [SerializeField] private float m_MoveSpeed = 5f;
        [SerializeField] private InventoryGrid m_Inventory;
        ...
        private void Update()
        {
            ...
            if (kb == null) return;
            if (kb[Key.E].wasPressedThisFrame) m_Interactor.InteractWithClosest();
            if (kb[Key.I].wasPressedThisFrame) m_Inventory?.ToggleInventory();
        }
